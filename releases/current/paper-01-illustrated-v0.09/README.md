...
The original mathematical body, theorem statements, proofs, equations, citation targets and native tables are preserved exactly. Changes are limited to illustration callouts, figures/captions, float configuration, an appendix page break, the edition date and the authorized author-name expansion to Akari Hayami (Jian-Yu Huang). The v0.08 release and the SVG/PNG production package are preserved separately.
