...
archive=ROOT.parent/'three_papers_v0_09_submission_preparation.zip'
...
receipt={'archive':archive.name,'sha256':sha(archive.read_bytes()),'bytes':archive.stat().st_size,
 'verified_payloads':len(files),'status':'local preparation complete; DOI/license/platform checks pending',
